...
public class computador {
         public static void main(String[] args) {
                ...
                p.busca();//MAR=pc
                if(p.r.getEscolha()==2) System.out.print(p.r.imprimirtudo()); /*System.out.println("  Memória:"+ mem.getMem());*/ System.out.println("  ");
                ...
                if(p.uc.getComando().equals("Salvar")){
                    ...
                    if(p.r.getEscolha()==3) System.out.print(p.r.imprimirtudo()); System.out.println("  Memória:"+ mem.getMem()); System.out.println("  ");
                 }
    }
}